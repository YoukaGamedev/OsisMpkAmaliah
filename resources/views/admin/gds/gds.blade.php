...
<body class="bg-gray-100 flex">
  ...
  <aside id="sidebar" class="bg-gray-800 w-0 md:w-16 hover:md:w-56 h-screen p-0 md:p-4 fixed top-0 left-0 z-20 transition-all duration-300 ease-in-out overflow-hidden group transform -translate-x-full md:translate-x-0 mt-20">
    ...
    <ul class="space-y-4">
      <li>
        <a href="{{ route('rekapgds.index') }}" class="flex items-center text-white p-3 rounded-lg hover:bg-gray-700 transition">
          <i class="fas fa-folder-open text-lg mr-3"></i>
          <span class="hidden group-hover:inline-block">Rekap GDS</span>
        </a>
      </li>
      <li>
        <a href="{{ route('tambahdata.index') }}" class="flex items-center text-white p-3 rounded-lg hover:bg-gray-700 transition">
          <i class="fas fa-user-plus text-lg mr-3"></i>
          <span class="hidden group-hover:inline-block">Daftar Siswa</span>
        </a>
      </li>
      <li>
        <a href="{{ route('jadwalgds.index') }}" class="flex items-center text-white p-3 rounded-lg hover:bg-gray-700 transition">
      ...
      <li class="mt-6 border-t border-gray-700 pt-4">
        <a href="{{ url('/admin') }}" class="flex items-center text-white p-3 rounded-lg hover:bg-gray-700 transition">
