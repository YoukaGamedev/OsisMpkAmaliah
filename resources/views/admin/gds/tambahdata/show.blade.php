...
<div class="p-6">
    <div class="space-y-4">
        ...
        <div class="bg-gray-50 rounded-lg p-4 space-y-4">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div class="text-gray-600 font-medium">Foto</div>
                <div>
                <img src="{{ asset('storage/' . $siswa->foto) }}" alt="Foto Siswa" class="w-32 h-32 object-cover rounded">
                </div>
            </div>
            <div class="grid grid-cols-2 gap-4">
                <div class="text-gray-600 font-medium">QR Code</div>
                <div>
                    <img src="{{ asset('storage/' . $siswa->qr_code) }}" alt="QR Code" class="w-32 h-32">
                </div>
            </div>
        </div>
    </div>
