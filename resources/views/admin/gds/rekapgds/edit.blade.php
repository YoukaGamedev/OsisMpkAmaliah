...
<div class="min-h-screen bg-gray-50 py-8">
    <div class="max-w-2xl mx-auto px-4">
        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden">
            ...
            <!-- Form Section -->
            <div class="p-6">
                <form action="{{ route('rekapgds.update', $rekap->id) }}" method="POST" class="space-y-6">
                    @csrf
                    @method('PUT') <!-- This is necessary for update method -->
