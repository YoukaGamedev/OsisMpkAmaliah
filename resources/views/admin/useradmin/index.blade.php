                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-4 py-3">
                                        <span class="px-2 py-1 text-xs font-medium rounded-full
                                            @if($dpt->role == 'admin_osis') bg-purple-100 text-purple-700
                                            @elseif($dpt->role == 'admin_pembina') bg-indigo-100 text-indigo-700
                                            @else bg-blue-100 text-blue-700 @endif">
                                            {{ ucwords(str_replace('_', ' ', $dpt->role)) }}
                                        </span>
                                    </td>
