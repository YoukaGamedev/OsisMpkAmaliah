...
<div class="container mx-auto py-5 px-4">
    <div class="flex justify-center">
        <div class="w-full lg:w-10/12">
            ...
            <!-- Tombol Kembali -->
        <div class="mb-4">
            <a href="{{ url('/user') }}" class="inline-flex items-center px-5 py-3 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition duration-200">
                                    ...
                                    <tr class="animate-fade-in" style="--animate-duration: 0.{{ $index + 3 }}s">
                                        ...
                                        <td class="px-4 py-2 text-center">
                                            <div class="flex justify-center gap-2">
                                                <a href="{{ route('user.agenda.show', $agenda->id) }}" class="bg-blue-500 text-white px-3 py-1 rounded hover:bg-blue-600">
                ...
                eventItem.innerHTML = `
                    <div class="card-body p-3">
                        ...
                        <div class="flex justify-end gap-2 mt-2">
                            <a href="{{ route('user.agenda.show', '') }}/${event.id}" class="bg-blue-500 text-white px-3 py-1 rounded hover:bg-blue-600">
