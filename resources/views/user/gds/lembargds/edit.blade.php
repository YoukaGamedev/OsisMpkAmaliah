        ...
        <form action="{{ route('pelanggaran.update', $pelanggaran->id_pelanggaran) }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <input type="date" name="tanggal_pelanggaran"
                        class="w-full px-4 py-3 border border-blue-400 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                        value="{{ old('tanggal_pelanggaran', \Carbon\Carbon::parse($pelanggaran->tanggal_pelanggaran)->toDateString()) }}"
                </div>
                ...
                <!-- Submit Button -->
                <div class="mt-6">
                    <button type="submit" class="w-full bg-gradient-to-r from-yellow-500 to-yellow-600 text-white py-3 rounded-lg shadow-md hover:from-yellow-600 hover:to-yellow-700 transition duration-300 font-bold text-lg">
