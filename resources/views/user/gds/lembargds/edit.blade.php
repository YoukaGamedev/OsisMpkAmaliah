        ...
        <div class="max-w-4xl mx-auto bg-white shadow-2xl rounded-2xl overflow-hidden border border-gray-100">
            ...
            <div class="bg-gradient-to-r from-indigo-600 via-purple-600 to-blue-600 text-white text-center py-6 relative overflow-hidden">
                ...
                <div class="relative z-10">
                    ...
                    <h1 class="font-bold text-2xl md:text-3xl">Edit Pelanggaran Siswa</h1>
                    <p class="text-indigo-100 mt-2">Perbarui data pelanggaran yang telah dicatat</p>
                </div>
            </div>
            ...
            <div class="p-8">
                ...
                <form action="{{ route('pelanggaran.update', $pelanggaran->id_pelanggaran) }}" method="POST" id="pelanggaranForm">
                    ...
                    <div class="mb-11 bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-xl border border-blue-200">
                        ...
                        <div class="mb-4">
                            <select id="selectSiswa" name="siswa_id"
                        ...
                        <!-- OSIS Indicator (optional toggle based on siswa selected) -->
                        <div id="osisIndicator" class="mb-4 {{ $pelanggaran->siswa->is_osis ? '' : 'hidden' }}">
                    ...
                    <div class="mb-8 bg-gradient-to-r from-red-50 to-pink-50 p-6 rounded-xl border border-red-200">
                        ...
                        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 mb-6">
                            @foreach ($attributes as $label => $data)
                                @php
                                    $checked = old($data['name'], $pelanggaran->{$data['name']}) == 0;
                                @endphp
                                    ...
                                    <div class="flex flex-col items-center text-center">
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="checkbox" name="{{ $data['name'] }}" id="{{ $data['name'] }}" 
                                                   class="violation-checkbox sr-only" value="0" {{ $checked ? 'checked' : '' }}>
                                            <label for="{{ $data['name'] }}" class="toggle-switch flex items-center cursor-pointer">
